...
namespace Photon.Chat.Demo
{
    ...
    /// </remarks>
    public class ChatGui_LHE_comment : MonoBehaviour, IChatClientListener
    {
        // Region & Guild 부분
        ...
        // 물음표 버튼의 help message 관련 부분인듯, 나에게는 필요X
        ...
        public void Start()
        {
            ...
            // 아래로는 photon chat app id 부재할 떄의 알람 표시 관련인 듯, 잘 넣어뒀으면 안 중요할듯
        ...
        private void SendChatMessage(string inputLine)
        {
            ...
            // 이 아래로 onconnected 전까지는 별로 안 중요한듯?
